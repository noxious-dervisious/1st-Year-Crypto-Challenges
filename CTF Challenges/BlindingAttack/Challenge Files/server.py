...
def main():
    ...
    while True:
        ...
        if x is 1:
            try:
                message = int(input('Enter the message to sign(int): '))
            ...
            try:
                sign = int(input('Enter the signature to verify(int): '))

                message = int(input('Message to verify(int): '))
...
# flag  = inctf{8cb7e8281302c5f177dddf03f0870a59}